#!/usr/bin/env python3
"""
定时文件清理工具 - Joy Marine 专用版
功能：循环定时删除指定文件夹中超过指定天数的文件
"""
...
# 配置文件路径
CONFIG_FILE = Path.home() / ".workbuddy" / "file_cleaner_config.json"
...
class FileCleanerApp:
    ...
    def create_widgets(self):
        ...
        self.folder_listbox = tk.Listbox(list_frame, height=4, font=("Monaco", 10))
        ...
        self.status_label = ttk.Label(status_frame, text="● 已停止",
                                     foreground="red", font=("Monaco", 12))
        self.status_label.pack(pady=(0, 5))

        self.next_run_label = ttk.Label(status_frame, text="下次执行: --",
                                       foreground="gray", font=("Monaco", 10))
        self.next_run_label.pack()

        # 日志区域
        self.log_text = tk.Text(status_frame, height=8, font=("Monaco", 9),
